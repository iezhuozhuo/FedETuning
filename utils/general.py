...
def cen_metric_save(loc_trainer, training_config, logger):
    ...
    line = f"{times}_{training_config.tuning_type}_" \
           f"lr={training_config.learning_rate}_epo={training_config.num_train_epochs}_" \
           f"valid_{loc_trainer.metric_name}={valid_metric:.3f}_"
